<form class="js-search-container js-search-form search-container pl-lg-5" action="{{ store.search_url }}" method="get">
	<div class="form-group m-0">
        ...
        <button type="submit" class="btn search-input-submit" value="{{ 'Buscar' | translate }}" aria-label="{{ 'Buscar' | translate }}">
            <svg class="icon-inline icon-lg"><use xlink:href="#search"/></svg>
        </button>
	</div>
</form>
