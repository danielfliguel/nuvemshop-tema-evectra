        ...
        {% embed "snipplets/forms/form-input.tpl" with{
          ...
          form_control_container_custom_class: 'col'} %}
            ...
            <div class="row m-0 align-items-center ">
              <span class="js-cart-quantity-btn form-quantity-icon d-flex align-items-center justify-content-center btn" onclick="LS.minusQuantity({{ item.id }}{% if not cart_page %}, true{% endif %})" data-component="quantity.minus">
            ...
            {% block input_append_content %}
              ...
              <span class="js-cart-quantity-btn form-quantity-icon d-flex align-items-center justify-content-center btn" onclick="LS.plusQuantity({{ item.id }}{% if not cart_page %}, true{% endif %})" data-component="quantity.plus">
