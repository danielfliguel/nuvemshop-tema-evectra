...
{% else %}
	...
	{% for section in ['home_order_position_1', 'home_order_position_2', 'home_order_position_3', 'home_order_position_4', 'home_order_position_5', 'home_order_position_6', 'home_order_position_7', 'home_order_position_8', 'home_order_position_9',  'home_order_position_10'] %}
	    ...
	    {% if section_select not in newArray %}
			...
			{% elseif section_select == 'categories_slider' %}

		    	{#  **** Categories slider ****  #}
				{% include 'snipplets/home/home-slider-categories.tpl' %}
			...
			{% elseif section_select == 'extra1' %}

		        {#  **** Extra 1 products ****  #}
				{% include 'snipplets/home/home-featured-products.tpl' with {'has_extra1': true} %}
			
			{% elseif section_select == 'extra2' %}

		        {#  **** Extra 2 products ****  #}
				{% include 'snipplets/home/home-featured-products.tpl' with {'has_extra2': true} %}
